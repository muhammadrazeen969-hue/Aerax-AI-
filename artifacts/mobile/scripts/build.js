...
function getDeploymentDomain() {
  ...
  // Replit (kept for backward compat if still on Replit)
  ...
  console.error(
    ...
    "Set one of: APP_DOMAIN, EXPO_PUBLIC_DOMAIN, VERCEL_URL, or RENDER_EXTERNAL_URL\n" +
    "Example: APP_DOMAIN=myapp.com pnpm run build",
  );
  process.exit(1);
}
...
function getExpoPublicReplId() {
  // Optional: used only on Replit for Expo Go deep linking. Safe to be undefined elsewhere.
